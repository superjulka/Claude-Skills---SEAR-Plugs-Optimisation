...
4. **No competitor brand names as target keywords.** Drop keywords containing competitor brand names (SurfEars, Bollsen, EQ Seals, etc.) — note them in a separate "Competitor brand queries — do not target" list for awareness only.
