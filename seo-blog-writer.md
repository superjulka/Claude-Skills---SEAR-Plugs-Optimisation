...
3. **No competitor brand names as targets or links.** Never target competitor brand keywords (SurfEars, Bollsen, EQ Seals, etc.) and never link to competitor product pages.
...
- Do not link to or name competitor earplug brands (SurfEars, Bollsen, EQ Seals, etc.)
